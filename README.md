...
**Command:**
```dig @100.31.3.72 -p 5353 epoch +short ```
...
**Command:**
```dig @100.31.3.72 -p 5353 tps +short```
...
**Command:**
```dig @100.31.3.72 -p 5353 blocktime +short```
...
**Command:**
```dig @100.31.3.72 -p 5353 top-validators +short```
...
**Command:**
```dig @100.31.3.72 -p 5353 price-chart +short```
...
**Command:**
```dig @100.31.3.72 -p 5353 sol-supply +short```
...
**Command:**
```dig @100.31.3.72 -p 5353 stake-data +short```
...
**Command:**
```dig @100.31.3.72 -p 5353 stake-graph +short```
...
**Command:**
```dig @100.31.3.72 -p 5353 stake-average-size +short```
...
**Command:**
```dig @100.31.3.72 -p 5353 help +short ```
